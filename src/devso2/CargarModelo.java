 ...
 * @author 146310
 */
public class CargarModelo extends javax.swing.JDialog {

    /**
     * Creates new form CargarModelo
     */
    public CargarModelo() {
        initComponents();
    ...
    private void initComponents() {
        ...
        tableCargarModelos = new javax.swing.JTable();
        ...
        jLabel1.setText("Cargar Modelos");

        tableCargarModelos.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null}
            },
            new String [] {
        ...
        jScrollPane1.setViewportView(tableCargarModelos);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CargarModelo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CargarModelo().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tableCargarModelos;
